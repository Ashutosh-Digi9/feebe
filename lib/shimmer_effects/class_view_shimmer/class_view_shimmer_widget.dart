...
import 'class_view_shimmer_model.dart';
export 'class_view_shimmer_model.dart';

class ClassViewShimmerWidget extends StatefulWidget {
  const ClassViewShimmerWidget({super.key});

  @override
  State<ClassViewShimmerWidget> createState() => _ClassViewShimmerWidgetState();
}

class _ClassViewShimmerWidgetState extends State<ClassViewShimmerWidget>
    with TickerProviderStateMixin {
  late ClassViewShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassViewShimmerModel());
