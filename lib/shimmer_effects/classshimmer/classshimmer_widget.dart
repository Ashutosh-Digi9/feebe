...
import 'classshimmer_model.dart';
export 'classshimmer_model.dart';

class ClassshimmerWidget extends StatefulWidget {
  const ClassshimmerWidget({super.key});

  @override
  State<ClassshimmerWidget> createState() => _ClassshimmerWidgetState();
}

class _ClassshimmerWidgetState extends State<ClassshimmerWidget>
    with TickerProviderStateMixin {
  late ClassshimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassshimmerModel());
