...
import 'main_dashboard_shimmer_model.dart';
export 'main_dashboard_shimmer_model.dart';

class MainDashboardShimmerWidget extends StatefulWidget {
  const MainDashboardShimmerWidget({super.key});

  @override
  State<MainDashboardShimmerWidget> createState() =>
      _MainDashboardShimmerWidgetState();
}

class _MainDashboardShimmerWidgetState extends State<MainDashboardShimmerWidget>
    with TickerProviderStateMixin {
  late MainDashboardShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainDashboardShimmerModel());
