...
import 'studentshimmer_model.dart';
export 'studentshimmer_model.dart';

class StudentshimmerWidget extends StatefulWidget {
  const StudentshimmerWidget({super.key});

  @override
  State<StudentshimmerWidget> createState() => _StudentshimmerWidgetState();
}

class _StudentshimmerWidgetState extends State<StudentshimmerWidget>
    with TickerProviderStateMixin {
  late StudentshimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentshimmerModel());
