...
import 'class_dashboard_shimmer_model.dart';
export 'class_dashboard_shimmer_model.dart';

class ClassDashboardShimmerWidget extends StatefulWidget {
  const ClassDashboardShimmerWidget({super.key});

  @override
  State<ClassDashboardShimmerWidget> createState() =>
      _ClassDashboardShimmerWidgetState();
}

class _ClassDashboardShimmerWidgetState
    extends State<ClassDashboardShimmerWidget> with TickerProviderStateMixin {
  late ClassDashboardShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassDashboardShimmerModel());
