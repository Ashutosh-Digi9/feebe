...
class AppUpdateWidget extends StatefulWidget {
  ...
  static String routePath = '/appUpdate';
            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/9efb2e58b7325f3aa72820a8e2fd9bf6.jpg',
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                  child: Text(
                    'We added lots of new features and fix some bugs to make your experirnces as smooth as possible',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (isAndroid) {
                        await launchURL(
                            'https://play.google.com/store/apps/details?id=com.digi9.feebe');
                      } else {
                        await launchURL(
                            'https://play.google.com/store/apps/details?id=com.digi9.feebe');
                      }
