import '/admin_dashboard/select_school/select_school_widget.dart';
...
class AddEventforAllSchoolsWidget extends StatefulWidget {
  const AddEventforAllSchoolsWidget({super.key});

  @override
  State<AddEventforAllSchoolsWidget> createState() =>
      _AddEventforAllSchoolsWidgetState();
}

class _AddEventforAllSchoolsWidgetState
    extends State<AddEventforAllSchoolsWidget> {
  late AddEventforAllSchoolsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddEventforAllSchoolsModel());
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      return SingleChildScrollView(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(uplodedImage.length,
                              (uplodedImageIndex) {
                        ...
                        onPressed: () async {
                          ...
                          if ((_model.eventName != null &&
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Pick up the event name and date ',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryText,
                                  ),
