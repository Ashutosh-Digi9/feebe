...
import 'delete_student_model.dart';
export 'delete_student_model.dart';

class DeleteStudentWidget extends StatefulWidget {
  const DeleteStudentWidget({super.key});
...
class _DeleteStudentWidgetState extends State<DeleteStudentWidget> {
  late DeleteStudentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteStudentModel());
  }
