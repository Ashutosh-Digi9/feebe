                          ...
                          children: [
                            ...
                            if ((_model.everyone == 0) ||
                              ...
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final schoolClassref = containerSchoolRecord
                                        .listOfClass
                                        .toList();
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        final schoolClassrefItem =
                                            schoolClassref[schoolClassrefIndex];
                                        return Padding(
                                          padding:
                  ...
                  return Container(
                    ...
                    child: StreamBuilder<List<SchoolClassRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SchoolClassRecord> containerSchoolClassRecordList =
                            snapshot.data!;
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, clasesIndex) {
                                          final clasesItem =
                                              clases[clasesIndex];
                                          return Padding(
                                            padding:
