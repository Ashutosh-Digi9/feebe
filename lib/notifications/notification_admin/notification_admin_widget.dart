                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemCount: ntices.length,
                                itemBuilder: (context, nticesIndex) {
                                  final nticesItem = ntices[nticesIndex];
                                  return Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        10.0, 0.0, 10.0, 5.0),
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.goNamed(
                                          'NotificationVIew',
                                          queryParameters: {
                                            'notificationref': serializeParam(
                                              nticesItem.reference,
                                        ...
                                        await nticesItem.reference.update({
                                                                  ...
                                                                  style: FlutterFlowTheme.of(
                                                                      ...
                                                                      .override(
                                                                        fontFamily:
                                                                            'Nunito',
                                                                        color: (nticesItem.tag == 'Notice') ||
                                                                                (nticesItem.tag == 'Home work') ||
                                                                                (nticesItem.tag == 'Assignment')
