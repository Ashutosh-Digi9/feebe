...
import '/index.dart';
import 'edit_parent_widget.dart' show EditParentWidget;
import 'package:flutter/material.dart';

class EditParentModel extends FlutterFlowModel<EditParentWidget> {
  ...
  List<ParentsDetailsStruct> newgur = [];
  void addToNewgur(ParentsDetailsStruct item) => newgur.add(item);
  void removeFromNewgur(ParentsDetailsStruct item) => newgur.remove(item);
  void removeAtIndexFromNewgur(int index) => newgur.removeAt(index);
  void insertAtIndexInNewgur(int index, ParentsDetailsStruct item) =>
      newgur.insert(index, item);
  void updateNewgurAtIndex(
          int index, Function(ParentsDetailsStruct) updateFn) =>
      newgur[index] = updateFn(newgur[index]);
  ...
  // Models for guardian dynamic component.
  late FlutterFlowDynamicModels<GuardianModel> guardianModels;
  ...
  void initState(BuildContext context) {
    ...
    guardianModels = FlutterFlowDynamicModels(() => GuardianModel());
  }
