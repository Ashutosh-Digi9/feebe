...
import 'eventdetailsparent_model.dart';
export 'eventdetailsparent_model.dart';
...
class EventdetailsparentWidget extends StatefulWidget {
  ...
  static String routeName = 'eventdetailsparent';
  static String routePath = '/eventdetailsparent';
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (widget.eventDetails?.eventDescription !=
                                          null &&
