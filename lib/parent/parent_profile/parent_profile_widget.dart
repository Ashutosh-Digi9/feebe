...
class ParentProfileWidget extends StatefulWidget {
  ...
  final List<ParentsDetailsStruct>? parentlist;
  final String? address;

  static String routeName = 'parent_profile';
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children:
                                  List.generate(parents.length, (parentsIndex) {
                                final parentsItem = parents[parentsIndex];
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                                  hoverColor: Colors.transparent,
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final students = widget.studentref!.toList();
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        final classeses = containerStudentsRecord
                                                                            .className
                                                                            .toList();
