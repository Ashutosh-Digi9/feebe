...
import 'add_noticeboard_class_model.dart';
export 'add_noticeboard_class_model.dart';

class AddNoticeboardClassWidget extends StatefulWidget {
  const AddNoticeboardClassWidget({
    super.key,
    this.schoolclassref,
  });
  ...
  @override
  State<AddNoticeboardClassWidget> createState() =>
      _AddNoticeboardClassWidgetState();
}

class _AddNoticeboardClassWidgetState extends State<AddNoticeboardClassWidget> {
  late AddNoticeboardClassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNoticeboardClassModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SchoolClassRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final addNoticeboardClassSchoolClassRecord = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextFormField(
                                controller: _model.titleNoticeTextController,
                  ...
                  Builder(
                    builder: (context) {
                      final calender = addNoticeboardClassSchoolClassRecord
                          .notice
