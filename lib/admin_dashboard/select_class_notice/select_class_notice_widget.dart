                                    ...
                                    if (valueOrDefault(
                                      ...
                                      if (_model.everyone == 2) {
                                        ...
                                        await NotificationsRecord.collection
                                          ...
                                          ...createNotificationsRecordData(
                                            content:
                                                '${widget.eventtitle} : ${widget.eventtitle} on ${dateTimeFormat("yMMMd", widget.datetime)}',
                                            descri: widget.description,
                                            datetimeofevent: widget.datetime,
                                            notification:
                                                updateNotificationStruct(
                                      ...
                                      while (FFAppState().loopmin <
                                        ...
                                        _model.schoolClassT =
                                            await SchoolClassRecord
                                                .getDocumentOnce(_model.classref
                                                    .elementAtOrNull(
                                                        FFAppState().loopmin)!);
                                        FFAppState().loopmin =
                                            FFAppState().loopmin + 1;
                                                  ...
                                                  onTap: () async {
                                                    if (!_model.classref
                                                        .contains(clasesItem
                                                            .reference)) {
                                                      _model.addToClassref(
                                                          clasesItem.reference);
                                                      _model.addToClassname(
                                                          clasesItem.className);
                                                      safeSetState(() {});
                                                    } else {
                                                      _model.removeFromClassref(
                                                          clasesItem.reference);
                                  ...
                                  onPressed: () async {
                                    if (_model.classref.isNotEmpty) {
                                      ...
                                      await NotificationsRecord.collection
                                        ...
                                        ...createNotificationsRecordData(
                                          content:
                                              'Notice is been added by teacher ${containerTeachersRecord?.teacherName} for classes ${functions.getCommaSeparatedClassNames(_model.classname.toList())}',
                                          descri: widget.description,
                                          datetimeofevent: widget.datetime,
                                          notification:
                                              updateNotificationStruct(
                                      ...
                                      while (FFAppState().loopmin <
                                        ...
                                        await NotificationsRecord.collection
                                          ...
                                          ...createNotificationsRecordData(
                                            content:
                                                'Notice is been added by teacher ${containerTeachersRecord?.teacherName} for class${_model.classesstudentQuery?.className}',
                                            descri: widget.description,
                                            datetimeofevent: widget.datetime,
                                            isread: false,
                                            notification:
