                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        safeSetState(() {});
                        _model.uploadedfile = await actions.uploadlimitfile(
                          context,
                        );
                        if (_model.uploadedfile?.errorMessage == null ||
                            _model.uploadedfile?.errorMessage == '') {
                          FFAppState().quickAction = QuickActionDatatypeStruct(
                            isUploading: _model.uploadedfile?.isUploading,
                            videoUrl: _model.uploadedfile?.videoUrl,
                            imageUrl: _model.uploadedfile?.imageUrl,
                          );
                          safeSetState(() {});
                          Navigator.pop(context);
                          await showModalBottomSheet(
