...
import 'indi_edit_students_model.dart';
export 'indi_edit_students_model.dart';

class IndiEditStudentsWidget extends StatefulWidget {
  const IndiEditStudentsWidget({
    super.key,
  ...
  @override
  State<IndiEditStudentsWidget> createState() => _IndiEditStudentsWidgetState();
}

class _IndiEditStudentsWidgetState extends State<IndiEditStudentsWidget> {
  late IndiEditStudentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndiEditStudentsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<StudentsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final indiEditStudentsStudentsRecord = snapshot.data!;
