...
import '/index.dart';
import 'add_student_manually_copy2_widget.dart'
    show AddStudentManuallyCopy2Widget;
import 'package:flutter/material.dart';

class AddStudentManuallyCopy2Model
    extends FlutterFlowModel<AddStudentManuallyCopy2Widget> {
  ...
  // Stores action output result for [Backend Call - Create Document] action in BackButtonOverrider widget.
  StudentsRecord? sdraftback;
  // Stores action output result for [Backend Call - Create Document] action in BackButtonOverrider widget.
  StudentsRecord? draftparent1back;
  // Stores action output result for [Backend Call - Create Document] action in BackButtonOverrider widget.
  StudentsRecord? guardianback;
  ...
  // Stores action output result for [Backend Call - Create Document] action in Icon widget.
  StudentsRecord? sdraft;
  // Stores action output result for [Backend Call - Create Document] action in Icon widget.
  StudentsRecord? draftparent1;
  // Stores action output result for [Backend Call - Create Document] action in Icon widget.
  StudentsRecord? guardian;
