...
import 'add_student_manually_copy2_model.dart';
export 'add_student_manually_copy2_model.dart';

class AddStudentManuallyCopy2Widget extends StatefulWidget {
  const AddStudentManuallyCopy2Widget({
    super.key,
  ...
  static String routeName = 'add_student_manuallyCopy2';
  static String routePath = '/addStudentManuallyCopy2';

  @override
  State<AddStudentManuallyCopy2Widget> createState() =>
      _AddStudentManuallyCopy2WidgetState();
}

class _AddStudentManuallyCopy2WidgetState
    extends State<AddStudentManuallyCopy2Widget> {
  late AddStudentManuallyCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStudentManuallyCopy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<SchoolRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final addStudentManuallyCopy2SchoolRecord = snapshot.data!;
                          ...
                          if ((_model.childnameTextController.text != '') ||
                            ...
                            var confirmDialogResponse = await showDialog<bool>(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text(
                                          '“You are about to leave this page. Would you like to save your progress? '),
                                      actions: [
                                        TextButton(
                                    ...
                                    ...mapToFirestore(
                                      {
                                        'List_of_students':
                                            FieldValue.arrayUnion(
                                                [_model.sdraft?.reference]),
                                        'student_data_list':
                                            FieldValue.arrayUnion([
                                          getStudentListFirestoreData(
                                            createStudentListStruct(
                                              studentName:
                                                  _model.sdraft?.studentName,
                                              studentId:
                                                  _model.sdraft?.reference,
                                              studentImage:
                                                  _model.sdraft?.studentImage,
                                              isDraft: true,
                                              clearUnsetFields: false,
                                            ),
                                            true,
                                    ...
                                    ...mapToFirestore(
                                      {
                                        ...
                                        'student_data_list':
                                          ...
                                          getStudentListFirestoreData(
                                            createStudentListStruct(
                                              studentName: _model
                                                  .draftparent1?.studentName,
                                              studentId: _model
                                                  .draftparent1?.reference,
                                              studentImage: _model
                                                  .draftparent1?.studentImage,
                                              isDraft: true,
                                              clearUnsetFields: false,
                                            ),
                                            true,
                                  ...
                                  ...mapToFirestore(
                                    {
                                      'List_of_students': FieldValue.arrayUnion(
                                          [_model.guardian?.reference]),
                                      'student_data_list':
                                          FieldValue.arrayUnion([
                                        getStudentListFirestoreData(
                                          createStudentListStruct(
                                            studentName:
                                                _model.guardian?.studentName,
                                            studentId:
                                                _model.guardian?.reference,
                                            studentImage:
                                                _model.guardian?.studentImage,
                                            isDraft: true,
                                            clearUnsetFields: false,
                                          ),
                                          true,
                                ...
                                context.goNamed(
                                  ...
                                  queryParameters: {
                                    'schoolref': serializeParam(
                                      addStudentManuallyCopy2SchoolRecord
                                          .reference,
                                    ...
                                    onPressed: () async {
                                      ...
                                      if ((_model.gnameTextController.text !=
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Tap on add button to add the gurdian',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (_model.userdocument1
                                          ...
                                          ...mapToFirestore(
                                            {
                                              ...
                                              'class_name': [
                                                _model.classes1234?.className
                                              ],
                                              'classref': [
                                                _model.classes1234?.reference
                                              ],
                                            },
                                          ),
                                        });
                                        ...
                                        triggerPushNotification(
                                          notificationTitle:
                                              'New student added to class ${_model.classes1234?.className}',
                                          notificationText:
                                              'New student added to class ${_model.classes1234?.className}',
                                          userRefs: _model
                                              .classes1234!.listOfteachersUser
                                              .toList(),
                                        ...
                                        await NotificationsRecord.collection
                                          ...
                                          ...createNotificationsRecordData(
                                            ...
                                            descri:
                                                'New student :  ${_model.childnameTextController.text} has been added to ${_model.classes1234?.className} Allergy : ${_model.allergiesTextController.text != '' ? _model.allergiesTextController.text : 'None'}',
                                            isread: false,
                                            notification:
                                            ...
                                            heading: 'Student Added to Class',
                                          ),
                                          ...mapToFirestore(
                                            {
                                              'userref': _model.classes1234
                                                  ?.listOfteachersUser,
                                            },
                                          ),
                                        });
                                        ...
                                        await addStudentManuallyCopy2SchoolRecord
                                            .reference
                                            .update({
                                          ...mapToFirestore(
                                            {
                                      ...
                                      _model.classrtu = await SchoolClassRecord
                                          .getDocumentOnce(widget.classref!);
                                      triggerPushNotification(
                                        notificationTitle: 'Added to Class',
                                        notificationText:
                                            '${_model.childnameTextController.text} is added to class ${_model.classrtu?.className}',
                                        userRefs: _model.parentsRef.toList(),
                                        initialPageName: 'Dashboard',
                                        parameterData: {},
                                      );
                                      ...
                                      await NotificationsRecord.collection
                                          ...
                                          notification:
                                            ...
                                            NotificationStruct(
                                              notificationTitle:
                                                  'Added to a class',
                                              descriptions:
                                                  'Added to class ${_model.classrtu?.className}',
                                              timeStamp: getCurrentTimestamp,
                                              isRead: false,
                                            ),
                                            clearUnsetFields: false,
                                        ...
                                        ...mapToFirestore(
                                          {
                                            'userref': _model.parentsRef,
                                            'towhome': [
                                              _model.classrtu?.className
                                            ],
                                          },
                                        ),
                                      });
