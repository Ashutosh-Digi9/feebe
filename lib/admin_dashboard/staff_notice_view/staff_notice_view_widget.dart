...
import 'staff_notice_view_model.dart';
export 'staff_notice_view_model.dart';

class StaffNoticeViewWidget extends StatefulWidget {
  const StaffNoticeViewWidget({
    super.key,
    this.eventDetails,
  ...
  static String routeName = 'Staff_notice_view';
  static String routePath = '/staffNoticeView';

  @override
  State<StaffNoticeViewWidget> createState() => _StaffNoticeViewWidgetState();
}

class _StaffNoticeViewWidgetState extends State<StaffNoticeViewWidget> {
  late StaffNoticeViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StaffNoticeViewModel());
  }
