                                                                ...
                                                                child: Align(
                                                                  ...
                                                                  child: Text(
                                                                    FFAppState().selectedDate !=
                                                                        ...
                                                                        : dateTimeFormat(
                                                                            "dd MMM y",
                                                                            editClassStudentCopyStudentsRecord.dateOfBirth!),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                                  ...
                                                                  text: editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().firstOrNull?.isemail !=
                                                                      ...
                                                                      ? (editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().firstOrNull!.isemail
                                                                          ? editClassStudentCopyStudentsRecord
                                                                              ...
                                                                              .firstOrNull
                                                                              ?.parentsEmail
                                                                          : functions.getUsernameFromEmail(editClassStudentCopyStudentsRecord
                                                                              .parentsDetails
                                                                              .where((e) =>
                                                                                  e.parentRelation ==
                                                                                      '')
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        controller:
                                                                            _model.emailmotherTextController ??=
                                                                                TextEditingController(
                                                                          text: editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().elementAtOrNull(1)?.isemail != null
                                                                              ? (editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().elementAtOrNull(1)!.isemail ? editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().elementAtOrNull(1)?.parentsEmail : functions.getUsernameFromEmail(editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().elementAtOrNull(1)!.parentsEmail))
                                                                              : editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().elementAtOrNull(1)?.parentsEmail,
                                                                        ),
                                                                        focusNode:
                                                                            _model.emailmotherFocusNode,
                                                                        autofocus:
                                                                            false,
                                                                        readOnly: editClassStudentCopyStudentsRecord.parentsDetails.where((e) => e.parentRelation == '').toList().length ==
                                                                                2
                                                                            ? true
                                                                            : false,
                                                                        obscureText:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (selectedFiles !=
                                                                              null) {
                                                                            safeSetState(() =>
                                                                                _model.isDataUploading_editMother = true);
                                                                            var selectedUploadedFiles =
                                                                                <FFUploadedFile>[];
                                                                          ...
                                                                          if (!functions
                                                                              .isValidFileFormat(_model.uploadedFileUrl_editMother)) {
                                                                            safeSetState(() {
                                                                              _model.isDataUploading_editMother = false;
                                  ...
                                  onPressed: () async {
                                    if (editClassStudentCopyStudentsRecord
                                      ...
                                      _model.addToParentdetails(
                                        ...
                                        userRef: editClassStudentCopyStudentsRecord
                                            .parentsDetails
                                            .where((e) =>
                                                e.parentsEmail ==
