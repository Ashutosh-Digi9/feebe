...
import '/confirmationpages/childcreated_copy/childcreated_copy_widget.dart';
...
import 'add_student_manually_copy_model.dart';
export 'add_student_manually_copy_model.dart';

class AddStudentManuallyCopyWidget extends StatefulWidget {
  const AddStudentManuallyCopyWidget({
    super.key,
  ...
  @override
  State<AddStudentManuallyCopyWidget> createState() =>
      _AddStudentManuallyCopyWidgetState();
}

class _AddStudentManuallyCopyWidgetState
    extends State<AddStudentManuallyCopyWidget> {
  late AddStudentManuallyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStudentManuallyCopyModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      safeSetState(() {
        _model.childnameTextController?.clear();
        _model.allergiesTextController?.clear();
        _model.addressTextController?.clear();
        _model.emailmotherTextController?.clear();
        _model.gnameTextController?.clear();
        _model.gnumberTextController?.clear();
        _model.gemailTextController?.clear();
        _model.numberfatherTextController?.clear();
        _model.numbermotherTextController?.clear();
        _model.emailfatherTextController?.clear();
        _model.parent2TextController?.clear();
        _model.parentnameTextController?.clear();
      });
      safeSetState(() {
        _model.bloodtypeValueController?.reset();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<SchoolRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final addStudentManuallyCopySchoolRecord = snapshot.data!;
                        ...
                        if (confirmDialogResponse) {
                          if (_model.pageViewCurrentIndex == 0) {
                                  ...
                                  'student_data_list': FieldValue.arrayUnion([
                                    getStudentListFirestoreData(
                                      createStudentListStruct(
                                        studentName:
                                            _model.studentdraft?.studentName,
                                        studentId:
                                            _model.studentdraft?.reference,
                                        studentImage:
                                            _model.studentdraft?.studentImage,
                                        isDraft: true,
                                ...
                                ...mapToFirestore(
                                  {
                                    ...
                                    'student_data_list': FieldValue.arrayUnion([
                                      getStudentListFirestoreData(
                                        createStudentListStruct(
                                          studentName:
                                              _model.studentdraft1?.studentName,
                                          studentId:
                                              _model.studentdraft1?.reference,
                                          studentImage: _model
                                              .studentdraft1?.studentImage,
                                          isDraft: true,
                                          clearUnsetFields: false,
                                        ),
                                        true,
                            ...
                            if (((_model.gnameTextController.text !=
                              ...
                              _model.addToParentsdetails(ParentsDetailsStruct(
                                ...
                                parentsEmail: _model.gemailTextController.text,
                                parentsPhone: _model.gnumberTextController.text,
                              ));
                              safeSetState(() {});
                              _model.pageno = 3;
                              safeSetState(() {});
                              ...
                              ...mapToFirestore(
                                {
                                  ...
                                  'student_data_list': FieldValue.arrayUnion([
                                    getStudentListFirestoreData(
                                      createStudentListStruct(
                                        studentName:
                                            _model.studentdraft2?.studentName,
                                        studentId:
                                            _model.studentdraft2?.reference,
                                        studentImage:
                                            _model.studentdraft2?.studentImage,
                                        isDraft: true,
                                        clearUnsetFields: false,
                                      ),
                                      true,
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              ...
                              'schoolref': serializeParam(
                                addStudentManuallyCopySchoolRecord.reference,
                                ParamType.DocumentReference,
                              ),
                              'datePick': serializeParam(
                                getCurrentTimestamp,
                                        ...
                                        if (_model.userdocument1
                                          ...
                                          await studentsRecordReference1.set({
                                            ...createStudentsRecordData(
                                              ...
                                              bloodGroup: _model.bloodtypeValue,
                                              schoolName:
                                                  addStudentManuallyCopySchoolRecord
                                          ...
                                          _model.student1new = StudentsRecord
                                              .getDocumentFromData({
                                            ...createStudentsRecordData(
                                              studentName: _model
                                                  .childnameTextController.text,
                                          ...
                                          await addStudentManuallyCopySchoolRecord
                                              .reference
                                              .update({
                                            ...mapToFirestore(
                                              {
