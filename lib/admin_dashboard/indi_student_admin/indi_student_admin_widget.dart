...
import 'indi_student_admin_model.dart';
export 'indi_student_admin_model.dart';

class IndiStudentAdminWidget extends StatefulWidget {
  const IndiStudentAdminWidget({
    super.key,
  ...
  @override
  State<IndiStudentAdminWidget> createState() => _IndiStudentAdminWidgetState();
}

class _IndiStudentAdminWidgetState extends State<IndiStudentAdminWidget> {
  late IndiStudentAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndiStudentAdminModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<StudentsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final indiStudentAdminStudentsRecord = snapshot.data!;
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: EditIndiStudentWidget(
                                        ...
                                        studentref:
                                            indiStudentAdminStudentsRecord
                                                .reference,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 0.0, 0.0, 5.0),
                                                child: Text(
                                                  'Age - ${functions.calculateAgeInYears(indiStudentAdminStudentsRecord.dateOfBirth!)}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 10.0),
                                                  child: Text(
                                                    'Allergies : ${indiStudentAdminStudentsRecord.allergiesOthers}',
                                              ...
                                              if (indiStudentAdminStudentsRecord
                                                          .document !=
                                                      '')
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                              ...
                                              child: Row(
                                                ...
                                                mainAxisAlignment:
                                                    MainAxisAlignment
                                                        .spaceEvenly,
                                                children: [
                                                  if ((indiStudentAdminStudentsRecord.parentsList.length == 1) ||
                                                      (indiStudentAdminStudentsRecord
                                                              .parentsList
                                                              .length ==
                                                          2) ||
                                                          ...
                                                          if (indiStudentAdminStudentsRecord
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  await launchURL(indiStudentAdminStudentsRecord
                                                                      .parentsDetails
                                                                      .firstOrNull!
                                                                      .document);
                                                                },
                          ...
                          Builder(
                            builder: (context) {
                              final classes = indiStudentAdminStudentsRecord
                                  .classref
                                  .toList();
                              if (classes.isEmpty) {
                                return Center(
                                                                          ...
                                                                          children: [
                                                                            StreamBuilder<SchoolClassRecord>(
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                ...
                                                                                return Text(
                                                                                  '${functions.calculateAttendancePercentage(textSchoolClassRecord.attendance.toList(), indiStudentAdminStudentsRecord.reference).toString()} %',
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Nunito',
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        'Pictures ${indiStudentAdminStudentsRecord.studentName}  tagged in',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Nunito',
