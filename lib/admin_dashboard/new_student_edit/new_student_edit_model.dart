...
import '/index.dart';
import 'new_student_edit_widget.dart' show NewStudentEditWidget;
import 'package:flutter/material.dart';

class NewStudentEditModel extends FlutterFlowModel<NewStudentEditWidget> {
  ...
  bool isDataUploading_newstudent6 = false;
  FFUploadedFile uploadedLocalFile_newstudent6 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_newstudent6 = '';
  ...
  bool isDataUploading_edit6567 = false;
  FFUploadedFile uploadedLocalFile_edit6567 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_edit6567 = '';
  ...
  bool isDataUploading_editMother12 = false;
  FFUploadedFile uploadedLocalFile_editMother12 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_editMother12 = '';
  ...
  UsersRecord? momUser;
  // Stores action output result for [Backend Call - API (Create Account)] action in Button widget.
  ApiCallResponse? gurcreate;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  UsersRecord? createdUser;
  // Stores action output result for [Backend Call - API (Create Account)] action in Button widget.
