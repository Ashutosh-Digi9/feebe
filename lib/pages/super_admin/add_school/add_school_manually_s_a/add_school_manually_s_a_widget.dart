...
import '/pages/super_admin/school_added_s_a/school_added_s_a_widget.dart';
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      cursorColor: FlutterFlowTheme.of(context).primaryText,
                      validator: _model.noofstudentsTextControllerValidator
                          .asValidator(context),
                      inputFormatters: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Principle phone number',
                        hintStyle: FlutterFlowTheme.of(context)
                            .labelMedium
                            .override(
                              fontFamily: 'Nunito',
                    ...
                    builder: (context) => Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.countofschool = await querySchoolRecordCount();

                          await SchoolRecord.collection
                              .doc()
                              .set(createSchoolRecordData(
                                schoolDetails: updateSchoolDetailsStruct(
                                  SchoolDetailsStruct(
                                    schoolId: functions
                                        .serialnumber(_model.countofschool!),
                                    schoolName:
                                        _model.schoolnameTextController.text,
                                    address:
                                        _model.schoolAddressTextController.text,
                                    noOfStudents: int.tryParse(
                                        _model.noofstudentsTextController.text),
                                    noOfFaculties: int.tryParse(_model
                                        .nooffacultiesTextController.text),
                                    noOfBranches: int.tryParse(
                                        _model.noofbranchesTextController.text),
                                    schoolImage: FFAppState().schoolimage,
                                  ),
                                  clearUnsetFields: false,
                                  create: true,
                                ),
                                principalDetails: updatePrincipalDetailsStruct(
