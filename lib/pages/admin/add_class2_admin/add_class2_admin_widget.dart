...
import 'add_class2_admin_model.dart';
export 'add_class2_admin_model.dart';

class AddClass2AdminWidget extends StatefulWidget {
  const AddClass2AdminWidget({super.key});

  @override
  State<AddClass2AdminWidget> createState() => _AddClass2AdminWidgetState();
}

class _AddClass2AdminWidgetState extends State<AddClass2AdminWidget> {
  late AddClass2AdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddClass2AdminModel());
