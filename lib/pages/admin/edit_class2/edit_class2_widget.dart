...
import 'edit_class2_model.dart';
export 'edit_class2_model.dart';

class EditClass2Widget extends StatefulWidget {
  const EditClass2Widget({super.key});

  @override
  State<EditClass2Widget> createState() => _EditClass2WidgetState();
}

class _EditClass2WidgetState extends State<EditClass2Widget> {
  late EditClass2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditClass2Model());
