...
import 'dashboard_admin2_model.dart';
export 'dashboard_admin2_model.dart';

class DashboardAdmin2Widget extends StatefulWidget {
  const DashboardAdmin2Widget({super.key});

  @override
  State<DashboardAdmin2Widget> createState() => _DashboardAdmin2WidgetState();
}

class _DashboardAdmin2WidgetState extends State<DashboardAdmin2Widget>
    with TickerProviderStateMixin {
  late DashboardAdmin2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardAdmin2Model());
    ...
    _model.titleReminderTextController ??= TextEditingController();
    _model.titleReminderFocusNode ??= FocusNode();

    _model.descriptionReminderTextController ??= TextEditingController();
    _model.descriptionReminderFocusNode ??= FocusNode();
  }
                          ...
                          child: Padding(
                            ...
                            child: PageView(
                              ...
                              onPageChanged: (_) async {
                                _model.pagenumber = _model.pageViewCurrentIndex;
                                safeSetState(() {});
                              },
                                              ...
                                              child: ListView(
                                                ...
                                                children: [
                                                  wrapWithModel(
                                                    ...
                                                    updateCallback: () =>
                                                        safeSetState(() {}),
                                                    child: const ClassesAdminWidget(),
                                                  ),
                                                ],
                                              ),
                                            ),
                                                    ...
                                                    children: [
                                                          ...
                                                          children: [
                                                            SizedBox(
                                                              ...
                                                              child:
                                                                  TextFormField(
                                                                controller: _model
                                                                    .titleReminderTextController,
                                                                focusNode: _model
                                                                    .titleReminderFocusNode,
                                                                autofocus:
                                                                    false,
                                                                obscureText:
                                                                    false,
                                                                ...
                                                                cursorColor:
                                                                    FlutterFlowTheme.of(
                                                                        ...
                                                                        .primaryText,
                                                                validator: _model
                                                                    .titleReminderTextControllerValidator
                                                                    .asValidator(
                                                                        context),
                                                              ),
                                                            ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: SizedBox(
                                                          ...
                                                          child: TextFormField(
                                                            controller: _model
                                                                .descriptionReminderTextController,
                                                            focusNode: _model
                                                                .descriptionReminderFocusNode,
                                                            autofocus: false,
                                                            obscureText: false,
                                                            decoration:
                                                                InputDecoration(
