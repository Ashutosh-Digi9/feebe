                      ...
                      children: [
                        ...
                        FFButtonWidget(
                              ...
                              : () async {
                                  ...
                                  final user =
                                    ...
                                    (functions.isValidEmail(
                                        ...
                                        ? _model.emailTextController.text
                                        : '${_model.emailTextController.text}@feebe.in'),
                          ...
                          options: FFButtonOptions(
                            ...
                            disabledTextColor: Color(0xFFACB5BB),
                          ),
                        ),
                        InkWell(
                          ...
                          onTap: () async {
                            _model.apiResult7fm = await ForgotpasswordCall.call(
                              userId: currentUserUid,
                              toPhoneNumber: currentPhoneNumber,
                            );

                            if ((_model.apiResult7fm?.succeeded ?? true)) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Sms is sent to your registered phone number',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
                                    ),
