...
class _AddSchoolLinkWidgetState extends State<AddSchoolLinkWidget> {
  late AddSchoolLinkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddSchoolLinkModel());
    ...
    _model.noofstudentsTextController ??= TextEditingController();
    _model.noofstudentsFocusNode ??= FocusNode();
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            focusNode: _model.noofstudentsFocusNode,
                            autofocus: false,
                            obscureText: false,
                            decoration: InputDecoration(
                              isDense: true,
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model
                                .noofstudentsTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                        ...
                        builder: (context) => Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.countofschool =
                                  await querySchoolRecordOnce();
                              if (functions.isSchoolNameInDocuments(
                                      _model.schoolnameTextController.text,
                                      _model.countofschool!.toList()) ==
                                  false) {
