                  ...
                  children: [
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Nunito',
                                color: (_model
                                            .nooffacultiesFocusNode?.hasFocus ??
                                        false)
                                    ? FlutterFlowTheme.of(context).primary
                                    : FlutterFlowTheme.of(context).alternate,
                                letterSpacing: 0.0,
                          ...
                          filled: true,
                          fillColor:
                              (_model.nooffacultiesFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).secondary
                                  : FlutterFlowTheme.of(context).tertiary,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Nunito',
                                color: (_model
                                            .noofbranchesFocusNode?.hasFocus ??
                                        false)
                                    ? FlutterFlowTheme.of(context).primary
                                    : FlutterFlowTheme.of(context).alternate,
                                letterSpacing: 0.0,
                          ...
                          filled: true,
                          fillColor:
                              (_model.noofbranchesFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).secondary
                                  : FlutterFlowTheme.of(context).tertiary,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                        ...
                        keyboardType: TextInputType.number,
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        validator: _model.noofbranchesTextControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                          FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                        ],
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Nunito',
                                color: (_model
                                            .schoolAddressFocusNode?.hasFocus ??
                                        false)
                                    ? FlutterFlowTheme.of(context).primary
                                    : FlutterFlowTheme.of(context).alternate,
                                letterSpacing: 0.0,
                          ...
                          filled: true,
                          fillColor:
                              (_model.schoolAddressFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).secondary
                                  : FlutterFlowTheme.of(context).tertiary,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Nunito',
                                color: (_model.contactNameFocusNode?.hasFocus ??
                                        false)
                                    ? FlutterFlowTheme.of(context).primary
                                    : FlutterFlowTheme.of(context).alternate,
                                letterSpacing: 0.0,
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Nunito',
                                color: (_model.contactPhonenumberFocusNode
                                            ?.hasFocus ??
                                        false)
                                    ? FlutterFlowTheme.of(context).primary
                                    : FlutterFlowTheme.of(context).alternate,
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor:
                              (_model.contactemailFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).secondary
                                  : FlutterFlowTheme.of(context).tertiary,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              ...
                              onPressed: () async {
                                ...
                                if (confirmDialogResponse) {
                                  ...
                                  if ((_model.createaccount2?.succeeded ??
                                    ...
                                    await schoolRecordReference
                                      ...
                                      principalDetails:
                                        ...
                                        PrincipalDetailsStruct(
                                          ...
                                          emailId: _model
                                              .contactemailTextController.text,
                                          principalImage: FFAppState().imageurl,
                                          principalId: _model.user?.reference,
                                        ),
                                        clearUnsetFields: false,
                                        create: true,
                                      ),
                                    ...
                                    _model.seandmail = await SendMailCall.call(
                                      toEmail: _model
                                          .contactemailTextController.text,
                                      userName: _model
                                          .contactemailTextController.text,
                                    ...
                                    shouldSetState = true;
                                    if ((_model.seandmail?.succeeded ?? true)) {
                                      context.goNamed(
                                        'SchoolAdded',
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          getJsonField(
                                            (_model.createaccount2?.jsonBody ??
                                                ''),
                                            r'''$.message''',
                                          ).toString(),
                                          style: TextStyle(
