...
import 'edit_admin_copy_model.dart';
export 'edit_admin_copy_model.dart';

class EditAdminCopyWidget extends StatefulWidget {
  const EditAdminCopyWidget({
    super.key,
  ...
  static String routeName = 'EditAdminCopy';
  static String routePath = '/editAdminCopy';

  @override
  State<EditAdminCopyWidget> createState() => _EditAdminCopyWidgetState();
}

class _EditAdminCopyWidgetState extends State<EditAdminCopyWidget> {
  late EditAdminCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAdminCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editAdminCopyUsersRecord = snapshot.data!;
                          ...
                          children: [
                            Container(
                              ...
                              child: Align(
                                ...
                                child: Text(
                                  editAdminCopyUsersRecord.displayName,
                                    ...
                                    child: Hero(
                                      tag: valueOrDefault<String>(
                                        FFAppState().profileimagechanged == true
                                            ? FFAppState().imageurl
                                            : editAdminCopyUsersRecord.photoUrl,
                                        'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/fee-be-to8bwt/assets/ro0v8oqh1xhd/Screenshot__317_-removebg-preview.png',
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.contactemailTextController ??=
                                              TextEditingController(
                                        text: editAdminCopyUsersRecord.isemail
                                            ? editAdminCopyUsersRecord.email
