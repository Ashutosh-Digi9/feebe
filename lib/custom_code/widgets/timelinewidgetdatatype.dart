...
class Timelinewidgetdatatype extends StatefulWidget {
  ...
  @override
  State<Timelinewidgetdatatype> createState() => _TimelinewidgetdatatypeState();
}
...
class _TimelinewidgetdatatypeState extends State<Timelinewidgetdatatype> {
  ...
  @override
  void didUpdateWidget(covariant Timelinewidgetdatatype oldWidget) {
...
class MeetingDataSource extends CalendarDataSource {
  ...
  @override
  String getSubject(int index) => _getMeetingData(index).eventTitle;
