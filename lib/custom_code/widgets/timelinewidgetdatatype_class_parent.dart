...
class TimelinewidgetdatatypeClassParent extends StatefulWidget {
  const TimelinewidgetdatatypeClassParent({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<TimelinewidgetdatatypeClassParent> createState() =>
      _TimelinewidgetdatatypeClassParentState();
}

class _TimelinewidgetdatatypeClassParentState
    extends State<TimelinewidgetdatatypeClassParent> {
  ...
  @override
  void didUpdateWidget(covariant TimelinewidgetdatatypeClassParent oldWidget) {
    super.didUpdateWidget(oldWidget);

    // Check if the timrlinewidget has changed
